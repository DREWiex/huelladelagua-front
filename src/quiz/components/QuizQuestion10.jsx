...
export const QuizQuestion10 = ({ nextPage }) => {
    ...
    const { question, description, answers, icons } = findQuestion(questions, 10); // destructuración de las propiedades 'question', 'description' y 'answers' del objeto que devuelve la función
